<template>
  <div class="privacy-container">
    ...
    <h3>Effective Date: Oct 26, 2023</h3>
    <ol>
      ...
      <li>
        ...
        <p>
          - Personal Information: We may collect information such as your name,
          email address, and other personally identifiable information when you
          use our services.
        </p>
        <p>
          - Usage Information: We may collect non-personal information about
          your interactions with our website and services, including but not
          limited to your IP address, browser type, and device information.
        </p>
      </li>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            - In connection with the sale, merger, or transfer of all or a
